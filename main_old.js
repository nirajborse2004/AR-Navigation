...
function setupGeometry() {
    ...
    occluderMaterial = new THREE.MeshStandardMaterial({ color: 0x000000    });
    ...
    navigationArea.add(createWallElement(new THREE.Vector3(-4.5, 1, 0), new THREE.Vector3(0, 0, 0), new THREE.Vector3(0.1, 3, 9.5)));  // Left boundary wall
    navigationArea.add(createWallElement(new THREE.Vector3(4.5, 1, 0), new THREE.Vector3(0, 0, 0), new THREE.Vector3(0.1, 3, 9.5)));   // Right boundary wall
    navigationArea.add(createWallElement(new THREE.Vector3(0, 1, 4.75), new THREE.Vector3(0, 0, 0), new THREE.Vector3(9, 3, 0.1)));   // Top boundary wall
    navigationArea.add(createWallElement(new THREE.Vector3(0, 1, -4.75), new THREE.Vector3(0, 0, 0), new THREE.Vector3(9, 3, 0.1)));  // Bottom boundary wall

    // Classrooms and Labs
    navigationArea.add(createWallElement(new THREE.Vector3(-3.5, 1, 3), new THREE.Vector3(0, 0, 0), new THREE.Vector3(0.1, 3, 2.5)));  // Room 501 left wall
    navigationArea.add(createWallElement(new THREE.Vector3(-2, 1, 3), new THREE.Vector3(0, 0, 0), new THREE.Vector3(0.1, 3, 2.5)));    // Room 502 left wall
    navigationArea.add(createWallElement(new THREE.Vector3(-0.5, 1, 3), new THREE.Vector3(0, 0, 0), new THREE.Vector3(0.1, 3, 2.5)));  // Room 503 left wall
    navigationArea.add(createWallElement(new THREE.Vector3(1, 1, 3), new THREE.Vector3(0, 0, 0), new THREE.Vector3(0.1, 3, 2.5)));     // Room 504 left wall
    navigationArea.add(createWallElement(new THREE.Vector3(2.5, 1, 3), new THREE.Vector3(0, 0, 0), new THREE.Vector3(0.1, 3, 2.5)));   // Room 505 left wall
    navigationArea.add(createWallElement(new THREE.Vector3(4, 1, 3), new THREE.Vector3(0, 0, 0), new THREE.Vector3(0.1, 3, 2.5)));     // Room 506 left wall

    navigationArea.add(createWallElement(new THREE.Vector3(-4, 1, 1), new THREE.Vector3(0, 0, 0), new THREE.Vector3(1, 3, 0.1)));      // Room 501 bottom wall
    navigationArea.add(createWallElement(new THREE.Vector3(-2.5, 1, 1), new THREE.Vector3(0, 0, 0), new THREE.Vector3(1, 3, 0.1)));    // Room 502 bottom wall
    navigationArea.add(createWallElement(new THREE.Vector3(-1, 1, 1), new THREE.Vector3(0, 0, 0), new THREE.Vector3(1, 3, 0.1)));      // Room 503 bottom wall
    navigationArea.add(createWallElement(new THREE.Vector3(0.5, 1, 1), new THREE.Vector3(0, 0, 0), new THREE.Vector3(1, 3, 0.1)));     // Room 504 bottom wall
    navigationArea.add(createWallElement(new THREE.Vector3(2, 1, 1), new THREE.Vector3(0, 0, 0), new THREE.Vector3(1, 3, 0.1)));       // Room 505 bottom wall
    navigationArea.add(createWallElement(new THREE.Vector3(3.5, 1, 1), new THREE.Vector3(0, 0, 0), new THREE.Vector3(1, 3, 0.1)));     // Room 506 bottom wall

    // Passage and Common Areas
    navigationArea.add(createWallElement(new THREE.Vector3(0, 1, 0), new THREE.Vector3(0, 0, 0), new THREE.Vector3(9, 3, 0.1)));       // Horizontal passage wall
    navigationArea.add(createWallElement(new THREE.Vector3(-2.5, 1, -2), new THREE.Vector3(0, 0, 0), new THREE.Vector3(0.1, 3, 2.5))); // Passage vertical wall (left)
    navigationArea.add(createWallElement(new THREE.Vector3(2.5, 1, -2), new THREE.Vector3(0, 0, 0), new THREE.Vector3(0.1, 3, 2.5)));  // Passage vertical wall (right)

    // create floor with new map
